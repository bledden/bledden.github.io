...
<div class="chart-container">
  ...
  <p class="chart-caption">arrwDB's Pareto frontier on SIFT-1M compared to reference implementations. All on r6i.16xlarge, single-threaded. Competitor data from <a href="https://ann-benchmarks.com">ann-benchmarks.com</a> (March 2025 run).</p>
</div>
